export const randomTestData = [
  ...
  },
  {
    ...
    answer:
      "One more thing I’d like to add is that I’ve always jumped at opportunities, preferring not to wait. Much more often than not, it has been advantageous. Sometimes I call it my gut instinct. Decisions usually need to be made quickly, and those who aren’t afraid to take a leap of faith are the ones who make it through ",
    upvoteCount: 0,
  },
  {
    id: "3",
  ...
  },
  {
    ...
    answer:
      "I have just realized that I’ve collected, processed, analyzed and presented the same data to my advisor twice. Once as a young, fresh, innocent first year student, and once today, as a student in my final year. Four years apart.",
    upvoteCount: 0,
  },
  {
    id: "5",
